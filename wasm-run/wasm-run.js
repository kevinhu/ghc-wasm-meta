#!/usr/bin/env -S deno run --allow-read --allow-write --v8-flags=--experimental-wasm-return_call,--liftoff-only,--no-wasm-bounds-checks,--no-wasm-stack-checks,--no-wasm-opt,--wasm-lazy-compilation,--wasm-lazy-validation
